...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "IfUxUc7wwIg00bZlsl6GyJx9L", consumerSecret: "cnUM3h6ZbzCiQxtiq9uIYmdXCvABy5BZIuMVXnXcu7a6oU0s0J")
    var loginSuccess: (() -> ())?
